...
using Specifications.SourceGenerator.Extensions;
using static Microsoft.CodeAnalysis.CSharp.SyntaxFactory;

namespace Specifications.SourceGenerator.Specifications;
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var specification in receiver.Specifications)
        {
            ...
            var entityIdentifier = specification.BaseList
                ...
                .Single(type => type.Identifier.ToString() == "Specifications")
...
public class SpecificationSyntaxReceiver : ISyntaxReceiver
{
    ...
    public void OnVisitSyntaxNode(SyntaxNode syntaxNode)
    {
        ...
        if (identifierTokens.Any(node => node.Identifier.ToString() == "Specifications"))
